...
from extra import LossFunctionMinimizer,ResidualsCalculator,fit_regression_tree_classifier_to_residuals

class PytorchBasedGenericGradientBoost():
    
    def __init__(self, type, n_trees, max_depth, GRADIENT_BOOST_LEARNING_RATE = 0.1, MINIMIZER_LEARNING_RATE = 0.001, MINIMIZER_TRAINING_EPOCHS = 5000,USE_CUDA=0):
        '''
